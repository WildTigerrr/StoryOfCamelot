...
public enum MainText {
    ...
    NICKNAME_SETTED(1, "*, да? Что ж, не мне тебя судить за такое. *Добро пожаловать*." +
            "\nРаз уж ты тут, не мог бы мне помочь с одним делом? Сходи в p1, спроси у местных стражников как обстановка."),
